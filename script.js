...
// Typing effect untuk title (optional)
...
// Particle effect pada hero (optional - simple version)
...
// Tambahkan CSS untuk particle animation
...
console.log('%cBuilt with ❤️ using HTML, CSS & JavaScript', 'color: #666; font-size: 12px;');